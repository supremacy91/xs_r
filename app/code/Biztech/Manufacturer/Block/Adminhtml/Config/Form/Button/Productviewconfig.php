...
class Productviewconfig extends \Magento\Config\Block\System\Config\Form\Field
{
    const BUTTON_TEMPLATE = 'config/form/button/layeredconfig.phtml';

    /**
     * Productviewconfig constructor.
    ...
    public function getButtonHtml()
    {
        ...
        $url = $this->getUrl('manufacturer/manufacturer/UpdateProductView', $params);
