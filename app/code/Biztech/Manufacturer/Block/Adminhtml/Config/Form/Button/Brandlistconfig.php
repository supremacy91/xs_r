...
class Brandlistconfig extends \Magento\Config\Block\System\Config\Form\Field
{
    const BUTTON_TEMPLATE = 'config/form/button/layeredconfig.phtml';

    /**
     * Brandlistconfig constructor.
    ...
    public function getButtonHtml()
    {
        ...
        $url = $this->getUrl('manufacturer/manufacturer/UpdateBrandList', $params);
